...
ALLOWED_EXTENSIONS = {'pd', 'png', 'jpg', 'jpeg'}
...
def drop_course(course_id):
    try:
        ...
        if payment_count > 0:
            return jsonify({
                "error": "Cannot drop course after payments have been made. Please contact administration."
            }), 400
...
def make_payment():
    ...
    try:
        ...
        try:
            ...
            response_data = {
                "msg": "Payment recorded successfully" if status == 'RECEIVED' else "Payment submitted",
